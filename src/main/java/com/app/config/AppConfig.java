...
public class AppConfig implements WebMvcConfigurer{
	...
	public LocalSessionFactoryBean sfObj() {
		...
		sf.setAnnotatedClasses(ShipmentType.class,Uom.class,OrderMethod.class,WhUserType.class,User.class,Document.class,Item.class,PurchaseOrder.class);
	...
	@Bean  public CommonsMultipartResolver multipartResolver() {   CommonsMultipartResolver cm=new CommonsMultipartResolver();   return cm;  }  
